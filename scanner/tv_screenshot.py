...
_FOCUS: dict[str, str] = {
    "seasonals": (
        ...
        "KHÔNG so sánh với 0%, KHÔNG nhìn cả năm — CHỈ xét slope của đoạn Tháng X → Tháng X+2. "
        "Hãy viết 3-4 câu phân tích: "
        "(1) Tháng hiện tại là Tháng mấy (dựa vào vị trí cuối đường 2026). "
        "Liệt kê từng năm trong 5 năm gần nhất: năm nào đi LÊN, năm nào đi XUỐNG trong đoạn 1-2 tháng tiếp theo đó. "
        ...
        "(3) Kết luận: 1-2 tháng tới lịch sử nghiêng về tăng hay giảm, "
...
_PROMPT_PAIR = (
    ...
    "nhìn vào đoạn Tháng X → Tháng X+2 của năm đó: đường dốc LÊN hay XUỐNG trong đoạn đó "
