...
_FOCUS: dict[str, str] = {
    "seasonals": (
        ...
        "(màu sắc khác nhau, nhãn năm + % tổng cả năm ở bên phải), trục X là 12 tháng, "
        "trục Y là % thay đổi lũy kế từ đầu năm. Đường năm hiện tại (2026) chạy đến điểm "
        "hiện tại vì năm chưa kết thúc — đây là điểm xuất phát để so sánh. "
        "Hãy viết 3-4 câu phân tích tập trung vào từ THỜI ĐIỂM HIỆN TẠI trở đi: "
        "(1) Nhìn vào vị trí tháng hiện tại trên trục X: trong số các năm trước, "
        "có bao nhiêu năm có đường đi LÊN từ điểm này đến cuối năm? "
        "Nêu tỉ lệ (ví dụ: 7/10 năm tăng) và năm tăng mạnh nhất là năm nào, tăng bao nhiêu %. "
        "(2) Đường 2026 hiện đang ở mức nào — cao hơn hay thấp hơn đa số các năm cùng thời điểm? "
        "Hướng của đường 2026 gần đây đang đi lên hay đi ngang/đi xuống? "
        "(3) Kết luận: theo lịch sử mùa vụ, từ tháng này đến cuối năm tỉ lệ tăng cao hay thấp, "
        "và năm nào có đồ thị đẹp nhất (hướng lên mạnh nhất) từ điểm này. "
        "Nêu rõ tên năm, con số %, không dùng từ mơ hồ."
    ),
    "forecast-price-target": (
...
_PROMPT_PAIR = (
    ...
    "Ảnh 1 là biểu đồ mùa vụ (seasonal) — mỗi đường là 1 năm, trục X là 12 tháng, trục Y là % thay đổi lũy kế từ đầu năm. "
    "Ảnh 2 là dự báo giá 1 năm tới (hình nón min/trung bình/max) + đồng hồ khuyến nghị analyst + biểu đồ EPS/Doanh thu. "
    "Hãy viết 3-4 câu tổng hợp tập trung vào góc nhìn từ THỜI ĐIỂM HIỆN TẠI: "
    "(1) Nhìn vào ảnh mùa vụ tại vị trí tháng hiện tại: trong các năm trước, "
    "có bao nhiêu năm có đường đi LÊN từ điểm này đến cuối năm? "
    "Nêu tỉ lệ (X/Y năm tăng) và năm nào tăng mạnh nhất từ điểm này, tăng bao nhiêu %. "
