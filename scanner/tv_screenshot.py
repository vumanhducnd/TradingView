...
_FOCUS: dict[str, str] = {
    "seasonals": (
        ...
        "Hãy viết 3-4 câu phân tích từ THỜI ĐIỂM HIỆN TẠI (điểm cuối của đường 2026) trở đi: "
        "(1) Tại vị trí tháng hiện tại, đếm trong 5 năm gần nhất (dùng nhãn bên phải để xác định tên năm): "
        "có bao nhiêu năm có đường đi LÊN từ điểm này đến cuối năm? "
        "Nêu tỉ lệ (X/5 năm) và năm tăng mạnh nhất từ điểm này là năm nào, tăng thêm bao nhiêu %. "
        "(2) Đường 2026 hiện đang ở mức % nào (đọc từ nhãn bên phải), "
        "cao hơn hay thấp hơn đa số các năm cùng thời điểm? "
        "(3) Kết luận: tỉ lệ lịch sử từ tháng này ủng hộ tăng hay giảm, và năm nào làm kịch bản tham chiếu tốt nhất. "
