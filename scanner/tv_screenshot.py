...
_FOCUS: dict[str, str] = {
    "seasonals": (
        ...
        "BƯỚC 1 — Xác định tháng hiện tại: nhìn vào điểm CUỐI (chấm cuối) của đường 2026 trên trục X, "
        "đó là Tháng X (ví dụ Tháng 7). "
        "BƯỚC 2 — Với mỗi trong 5 năm gần nhất (đọc tên từ nhãn bên phải): "
        "nhìn vào đoạn từ Tháng X đến Tháng X+2 CỦA NĂM ĐÓ trên biểu đồ. "
        "ĐI LÊN = đường dốc lên trong đoạn đó (điểm cuối đoạn CAO HƠN điểm đầu đoạn trên trục Y). "
        "ĐI XUỐNG = đường dốc xuống trong đoạn đó (điểm cuối đoạn THẤP HƠN điểm đầu đoạn trên trục Y). "
        "KHÔNG so sánh với 0%, KHÔNG nhìn cả năm — CHỈ xét slope của đoạn Tháng X → Tháng X+1. "
        "Hãy viết 3-4 câu phân tích: "
        "(1) Tháng hiện tại là Tháng mấy (dựa vào vị trí cuối đường 2026). "
        "Liệt kê từng năm trong 5 năm gần nhất: năm nào đi LÊN, năm nào đi XUỐNG trong đoạn 1 tháng tiếp theo đó. "
        "Nêu tỉ lệ (X/5 năm tăng), năm tăng mạnh nhất tăng bao nhiêu %, năm giảm mạnh nhất giảm bao nhiêu %. "
        "(2) Đường 2026 đang ở mức % nào (nhãn bên phải), slope gần đây đang lên hay xuống? "
        "(3) Kết luận: 1 tháng tới lịch sử nghiêng về tăng hay giảm, "
        "mức kỳ vọng trung bình khoảng bao nhiêu %, năm nào là kịch bản tham chiếu tốt nhất. "
...
_PROMPT_PAIR = (
    ...
    "Hãy viết 3-4 câu tổng hợp tập trung vào 1 THÁNG TIẾP THEO: "
    "(1) Từ ảnh mùa vụ: xác định Tháng X = vị trí cuối đường 2026 trên trục X. "
    "Với mỗi trong 5 năm gần nhất (đọc tên từ nhãn bên phải), "
    "nhìn vào đoạn Tháng X → Tháng X+1 của năm đó: đường dốc LÊN hay XUỐNG trong đoạn đó "
    "(ĐI LÊN = điểm cuối đoạn cao hơn điểm đầu đoạn; KHÔNG so sánh với 0% hay nhìn cả năm). "
    "Liệt kê từng năm lên/xuống, nêu tỉ lệ (X/5 năm tăng), năm tăng mạnh nhất tăng bao nhiêu %. "
