...
GUIDE = (
    ...
    "• Canh mua từng phần tại <b>giá đóng cửa</b> khoảng ngày xuất hiện tín hiệu\n"
    "\n"
    "<b>🎯 Chốt lời từng phần sau khi mua:</b>\n"
    "• Khi giá chạm <b>vùng kháng cự</b> → chốt 30–50% vị thế\n"
